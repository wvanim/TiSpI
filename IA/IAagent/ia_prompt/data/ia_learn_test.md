Ce cours pour apprentissage du format Tispi est il clair ?
...
<indentation> track_name [ num_frame : value, value ; ... ] 

```
P nameA
  T face[0: f0 ; 10: f2 ; 40
...
Les piste portent leur rôle. 
Les pistes de controle du temps de groupe - tag et stop - peuvent se placer indifférement dans n'importe quelle Piece. 
...
* La Pièce la moteur d'animation repartira à l'appel la fonction `play()` (qui repasse le flag à `true`).
...
P anim
  ...
  T pos[0: 0, 0 ; 100: 500, 300] ← piste de propriété
  F f0 image "img.png"
```
